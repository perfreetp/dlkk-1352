...
export const defaultRecords: ChatRecord[] = [
  {
    ...
    actorIds: [defaultActors[0].id, defaultActors[1].id],
    actorsSnapshot: {
      [defaultActors[0].id]: { id: defaultActors[0].id, name: defaultActors[0].name, avatar: defaultActors[0].avatar, tone: defaultActors[0].tone, color: defaultActors[0].color },
      [defaultActors[1].id]: { id: defaultActors[1].id, name: defaultActors[1].name, avatar: defaultActors[1].avatar, tone: defaultActors[1].tone, color: defaultActors[1].color },
    },
    messages: [],
    isFavorite: true,
    createdAt: now - 86400000 * 2,
    ...
    pinnedMemories: [],
    reviewNotes: { conflict: '', characterStates: '', nextSteps: '', tags: ['暧昧推进', '日常'] },
    reviewSummary: '',
  },
  {
    id: generateId(),
    ...
    actorsSnapshot: {
      [defaultActors[0].id]: { id: defaultActors[0].id, name: defaultActors[0].name, avatar: defaultActors[0].avatar, tone: defaultActors[0].tone, color: defaultActors[0].color },
      [defaultActors[2].id]: { id: defaultActors[2].id, name: defaultActors[2].name, avatar: defaultActors[2].avatar, tone: defaultActors[2].tone, color: defaultActors[2].color },
      [defaultActors[4].id]: { id: defaultActors[4].id, name: defaultActors[4].name, avatar: defaultActors[4].avatar, tone: defaultActors[4].tone, color: defaultActors[4].color },
    },
    messages: [],
    isFavorite: false,
    createdAt: now - 86400000,
    ...
    pinnedMemories: [],
    reviewNotes: { conflict: '', characterStates: '', nextSteps: '', tags: ['欢乐日常', '多角色'] },
    reviewSummary: '',
  },
];
